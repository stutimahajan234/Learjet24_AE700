function MAV = learjet_parameters()
...
%MAV = learjet_parameters();e = Euler2Quaternion(MAV.phi0, MAV.theta0, MAV.psi0);
...
MAV.C_D_q         = 0.0;
MAV.C_m_q         = -15.5;
MAV.C_L_delta_e   = 0.46;
MAV.C_D_delta_e   = 0.0;
MAV.C_m_delta_e   = -1.24;
MAV.M             = 50;
MAV.alpha0        = 0.47;
MAV.epsilon       = 0.16;
MAV.C_D_p         = 0.0;
...
MAV.C_n_r         = -0.200;
MAV.C_Y_delta_a   = 0.0;
MAV.C_ell_delta_a = 0.178;
MAV.C_n_delta_a   = -0.02;
MAV.C_Y_delta_r   = 0.14;
MAV.C_ell_delta_r = 0.019;
MAV.C_n_delta_r   = -0.074;
